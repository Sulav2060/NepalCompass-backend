...
export interface ApiArrivingArriving extends Schema.CollectionType {
  collectionName: 'arrivings';
  info: {
    singularName: 'arriving';
    pluralName: 'arrivings';
  ...
  attributes: {
    arriving: Attribute.Component<'page.section', true>;
    city: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::arriving.arriving',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSidebarSidebar extends Schema.SingleType {
  ...
  attributes: {
    SIdebarItems: Attribute.Component<'sidebar.links', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
